...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './trail-path-waypoint.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRAILPATHWAYPOINT_LIST actions', async () => {
    ...
    it('dispatches FETCH_TRAILPATHWAYPOINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRAILPATHWAYPOINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRAILPATHWAYPOINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRAILPATHWAYPOINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRAILPATHWAYPOINT actions', async () => {
      const expectedActions = [
        {
