...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './trail.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRAIL_LIST actions', async () => {
    ...
    it('dispatches FETCH_TRAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRAIL actions', async () => {
      const expectedActions = [
        {
