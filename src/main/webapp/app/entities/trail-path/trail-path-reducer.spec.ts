...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRAILPATH_LIST actions', async () => {
    ...
    it('dispatches FETCH_TRAILPATH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRAILPATH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRAILPATH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRAILPATH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRAILPATH actions', async () => {
      const expectedActions = [
        {
